                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Tambah Category</h5>
                                        </div>
                                        <ul class="breadcrumb">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Form Entri Data Category</h5>
                                    </div>
                                    <div class="card-body">
                                        <form method="POST">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="nama_kategori" placeholder="Contoh: Programming" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-3">
                                                <button type="submit" name="simpan" class="btn btn-primary">
                                                    <i class="feather icon-plus-circle"></i> Simpan Category
                                                </button>
